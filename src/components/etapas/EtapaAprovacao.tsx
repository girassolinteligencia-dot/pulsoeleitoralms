    ...
    >
      ...
      <div className="w-full max-w-xl grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 sm:mt-8">
        ...
        >
          ...
          <span className="text-sm font-bold uppercase tracking-[0.24em] sm:tracking-[0.3em] text-[#f5f0e8] group-hover:text-[#a8c47a] transition-colors">Aprovo</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-sm font-bold uppercase tracking-[0.24em] sm:tracking-[0.3em] text-[#f5f0e8] group-hover:text-[#d97757] transition-colors">Desaprovo</span>
        </motion.button>
      </div>
