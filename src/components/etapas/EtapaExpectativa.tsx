      ...
      <div className="w-full max-w-xl grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 sm:mt-8">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <span className="text-sm font-bold uppercase tracking-[0.22em] sm:tracking-[0.3em] text-[#f5f0e8] group-hover:text-[#c8933a] transition-colors">Tem Força</span>
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <span className="text-sm font-bold uppercase tracking-[0.22em] sm:tracking-[0.3em] text-[#f5f0e8] opacity-60 transition-colors group-hover:opacity-100">Sem Força</span>
